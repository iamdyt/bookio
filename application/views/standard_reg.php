...
<?php if (isset($page_title) && $page_title == 'Standard-Register'): ?>
<!-- Register form -->
<div class="container" <?php if(settings()->site_info == 3){echo "d-hide";} ?>">
    <div class="row">
        <div class="col-md-4 offset-md-4 my-1 card card-body" data-aos="fade-left" data-aos-duration="200" >
            ...
            <?php else: ?>
            <div class="mb-6 text-center">
                <h3 class="mb-0 custom-font">Standard Plan Registration</h3>
                ...
                <div class="row mt-2">
                    ...
                    <div class="col-md-12 center">
                        <input type="hidden" name="plan"
                            value="<?php if(isset($_GET['plan'])){echo html_escape($_GET['plan']);}else{echo "standard";} ?>">
                        ...
                        <button type="submit"
                            class="btn btn-primary btn-block mt-4 mb-0 register_button" style="background-color: #8833ff; border:none;" disabled="disabled"><?php echo trans('register') ?></button>
                    </div>
                </div>
