    ...
    <div class="row">
        <div class="col-md-4 offset-md-4 my-1 card card-body" data-aos="fade-left" data-aos-duration="200">
            ...
            <div class="mb-6 text-center">
                ...
                <h3 class="mb-0 custom-font">PREMIUM PLAN</h3>
            </div>
            ...
            <form id="" class="authorization__form authorization__form--shadow leave_con" method="post"
                action="<?=base_url('auth/save_agent') ?>">
                ...
                <div class="row mt-2">
                    ...
                    <div class="col-md-12 center">
                        ...
                        <button type="submit"
                            class="btn btn-primary btn-block mt-4 mb-0" style="background-color: #8833ff; border:none;" ><?php echo trans('register') ?></button>
                    </div>
                </div>
