        ...
        <div class="col-md-4">
                    ...
                    <form id="cat-form" method="post" class="validate-form" action="<?php echo base_url('admin/settings/set_language')?>" role="form">
                        ...
                        <div class="form-group mb-4">
                            <div class="custom-control custom-switch prefrence-items ml-10">
                              <input type="checkbox" name="enable_multilingual" class="" value="1" id="switch-88" <?php if($settings->enable_multilingual == 1){echo "checked";} ?>>
                        ...
                        <div class="form-group mb-2">
                          <select class=" nice_select form-control" name="language">
            ...
            <div class="card">
                <div class="card-header bg-primary text-white">
                  ...
                  <?php else: ?>
                    <div class="card-title"> <?php echo trans('add-new-language') ?> </div>
                  <?php endif; ?>
                </div>
                    ...
                    <div class="card-body p-0">
                        <div class="row">
                            <div class="col-md-12 col-sm-12 col-xs-12 table-responsive scroll">
                                <table class="table table-striped <?php if(count($languages) > 5){echo "datatable";} ?>">
                                    <thead>
                                        <tr>
                                            <th>S/N</th>
                                    ...
                                    <tbody>
                                      <?php $i=1; foreach ($languages as $lang): ?>
                                        <tr id="row_<?php echo html_escape($lang->id); ?>">
                                            ...
                                            <td>
                                                <span class="badge bg-secondary-soft fs-15 text-dark"><?php echo html_escape($lang->short_name); ?></span>
                                            </td>
                                            <td>
                                                <?php if ($lang->text_direction == 'rtl'): ?>
                                                  <span class="badge bg-secondary-soft text-dark"><?php echo strtoupper($lang->text_direction); ?></span>
                                                <?php else: ?>
                                                  <span class="badge bg-secondary-soft text-dark"><?php echo strtoupper($lang->text_direction); ?></span>
                                                <?php endif ?>
                                            </td>
