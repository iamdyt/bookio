              ...
              <div class="row pb-5">
                <?php $i=1; foreach ($packages as $package): ?>
                  <div class="col-lg-4 col-sm-12 col-xs-12 text-center">
                     ...
                     <div class="pricing-table purple text-center bg-white shadow-sm py-2 border-2 border-start border-primary rounded-lg">

                        <?php if ($package->status == 1): ?>
                          <span class="badge bg-secondary font-weight-bold"><i class="lni lni-user"></i> <?php echo get_total_user_by_package($package->id) ?></span>

                          <label class="badge bg-success brd-20"><i class="lnib lni-checkmark"></i> <?php echo trans('active') ?></label>
                        <?php else: ?>
                          <span class="badge bg-secondary font-weight-bold"><i class="fas fa-users"></i> <?php echo get_total_user_by_package($package->id) ?></span>

                          <label class="badge bg-warning brd-20"><i class="fas fa-eye-slash"></i> <?php echo trans('hidden') ?></label>
                        <?php endif ?>
              ...
              <div class="col-lg-12">
                <div class="card">
                    ...
                    <div class="card-header">
                      <span class="card-title"><?php echo trans('update-plan') ?> - <?php echo html_escape($package[0]['name']) ?></span>
                      <span class="float-end bg-secondary rounded text-light">
                        <a href="<?php echo base_url('admin/package') ?>" class="btn text-white"><i class="fas fa-chevron-left"></i> <?php echo trans('back') ?></a>
                      </span>
                    </div>  
                    ...
                    <form method="post" enctype="multipart/form-data" class="validate-form" action="<?php echo base_url('admin/package/add')?>" role="form" novalidate>
                      ...
                      <div class="card-body">
                        ...
                        <div class="row mt-50">
                          <div class="col-md-12 p-20 plan-item">
