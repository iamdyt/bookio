          ...
          <div class="col-md-4 pr-4">
              <div class="card add_area2 <?php if(isset($page_title) && $page_title == "Edit Category"){echo "d-block";}else{echo "hide";} ?>">
                ...
                <div class="card-header bg-primary text-white">
                  ...
                  <?php else: ?>
                    <span class="card-title pt-2"><?php echo trans('create-new-category') ?></span>
                  <?php endif; ?>
                  ...
                  <div class="card-tools d-inline float-end">
                    ...
                    <?php else: ?>
                      ...
                      <a href="#" class="text-right btn btn-white text-dark btn-sm cancel_btn2"><i class="fa fa-angle-left"></i> <?php echo trans('back') ?></a>
                    <?php endif; ?>
                  </div>
                </div>
              ...
              <?php if (isset($page_title) && $page_title != "Edit Category"): ?>
                <div class="card list_area2">
                  ...
                  <div class="card-header bg-primary text-white">
                    <?php if (isset($page_title) && $page_title == "Edit Category"): ?>
                      <span class="card-title pt-2">Edit <a href="<?php echo base_url('admin/services/edit_category') ?>" class="pull-right btn btn-secondary btn-sm"><i class="fa fa-angle-left"></i> <?php echo trans('back') ?></a></span>
                    <?php else: ?>
                      <span class="card-title pt-2"><?php echo trans('categories') ?></span>
                    <?php endif; ?>

                    <div class="card-tools d-inline float-end">
                      <a href="#" class="pull-right btn btn-white text-dark btn-sm add_btn2"><i class="fa fa-plus"></i> <?php echo trans('create-new-category') ?></a>
                    </div>
                  </div>
          ...
          <div class="col-md-8 <?php if(strlen(settings()->ind_code) != 40){echo "d-none";} ?>">
            ...
            <div class="card add_area <?php if(isset($page_title) && $page_title == "Edit"){echo "d-block";}else{echo "hide";} ?>">
                <div class="card-header with-border bg-primary text-white">
                  <?php if (isset($page_title) && $page_title == "Edit"): ?>
                    <span class="card-title pt-2"><?php echo trans('edit') ?></span>
                  <?php else: ?>
                    <span class="card-title pt-2"><?php echo trans('create-new-service') ?> </span>
                  <?php endif; ?>
                  ...
                  <div class="card-tools d-inline float-end">
                    <?php if (isset($page_title) && $page_title == "Edit"): ?>
                      <a href="<?php echo base_url('admin/services') ?>" class="pull-right btn btn-secondary btn-sm"><i class="fa fa-angle-left"></i> <?php echo trans('back') ?></a>
                    <?php else: ?>
                      <a href="#" class="text-right btn btn-white text-dark cancel_btn btn-sm"><?php echo trans('services') ?></a>
                    <?php endif; ?>
                  </div>
                </div>
            ...
            <?php if (isset($page_title) && $page_title != "Edit"): ?>
              <div class="card list_area">
                <div class="card-header with-border bg-primary text-white">
                  <?php if (isset($page_title) && $page_title == "Edit"): ?>
                    <span class="card-title pt-2"><?php echo trans('edit') ?> <a href="<?php echo base_url('admin/services') ?>" class="pull-right btn btn-sm btn-primary btn-sm"><i class="fa fa-angle-left"></i> <?php echo trans('back') ?></a></span>
                    <?php else: ?>
                      <span class="card-title pt-2"><?php echo trans('services') ?> </span>
                    <?php endif; ?>

                    <div class="card-tools d-inline float-end">
                      <a href="#" class="pull-right btn btn-sm btn-white text-dark add_btn"><i class="fa fa-plus"></i> <?php echo trans('create-new-service') ?></a>
                    </div>
                </div>
                        ...
                        <tr id="row_<?php echo html_escape($service->id); ?>">
                          ...
                          <td>
                            <?php if (!empty($service->category_id)): ?>
                              ...
                              <span class="badge bg-primary"><?php if(isset($category)){echo html_escape($category);} ?></span>
                            <?php else: ?>
