          ...
          <div class="col-md-12">
            ...
            <div class="card add_area <?php if(isset($page_title) && $page_title == "Edit"){echo "d-block";}else{echo "hide";} ?>">
              <div class="card-header with-border bg-primary text-white">
                ...
                <div class="card-tools d-inline float-end">
                  ...
                  <?php else: ?>
                    <a href="#" class="text-right btn btn-white text-dark cancel_btn btn-sm"><?php echo trans('gallery') ?></a>
                  <?php endif; ?>
                </div>
              </div>
            ...
            <?php if (isset($page_title) && $page_title != "Edit"): ?>
              <div class="card list_area">
                <div class="card-header with-border  bg-primary text-white">
                  <?php if (isset($page_title) && $page_title == "Edit"): ?>
                    <span class="card-title pt-2"><?php echo trans('edit') ?> <a href="<?php echo base_url('admin/gallery') ?>" class="pull-right btn btn-sm btn-primary btn-sm"><i class="fa fa-angle-left"></i> <?php echo trans('back') ?></a></span>
                  <?php else: ?>
                    <span class="card-title pt-2"><?php echo trans('galleries') ?> </span>
                  <?php endif; ?>
