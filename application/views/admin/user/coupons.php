          ...
          <div class="col-lg-12">
            <div class="card add_area <?php if(isset($page_title) && $page_title == "Edit"){echo "d-block";}else{echo "hide";} ?>">
              <div class="card-header with-border bg-primary text-white">
                ...
                <?php else: ?>
                  <span class="card-title pt-2"><?php echo trans('new-coupon') ?></span>
                <?php endif; ?>
                ...
                <div class="card-tools float-end">
                  ...
                  <?php else: ?>
                    <a href="#" class="text-right btn btn-white text-dark cancel_btn btn-sm"><?php echo trans('coupons') ?></a>
                  <?php endif; ?>
                </div>
              </div>
          ...
          <div class="col-lg-12">
            <?php if (isset($page_title) && $page_title != "Edit"): ?>
              <div class="card list_area">
                <div class="card-header with-border bg-primary text-white">
                  <?php if (isset($page_title) && $page_title == "Edit"): ?>
                    <span class="card-title pt-2"><?php echo trans('edit') ?> <a href="<?php echo base_url('admin/coupons') ?>" class="pull-right btn btn-sm btn-primary btn-sm"><i class="fa fa-angle-left"></i> <?php echo trans('back') ?></a></span>
                  <?php else: ?>
                    <span class="card-title pt-2"><?php echo trans('coupons') ?> </span>
                  <?php endif; ?>

                  <div class="card-tools float-end">
                   <a href="#" class="pull-right btn btn-sm btn-white text-dark add_btn"><i class="fa fa-plus"></i> <?php echo trans('new-coupon') ?></a>
                  </div>
                </div>
