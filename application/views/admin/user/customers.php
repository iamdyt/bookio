        ...
        <div class="row">
          <div class="col-md-12">
            ...
            <div class="card add_area <?php if(isset($page_title) && $page_title == "Edit"){echo "d-block";}else{echo "hide";} ?>">
              <div class="card-header bg-primary text-white with-border">
                <?php if (isset($page_title) && $page_title == "Edit"): ?>
                  <span class="card-title"><?php echo trans('edit') ?></span>
                <?php else: ?>
                  <span class="card-title"><?php echo trans('create-new') ?> </span>
                <?php endif; ?>

                <div class="card-tools pull-right float-end d-inline">
                  <?php if (isset($page_title) && $page_title == "Edit"): ?>
                    <a href="<?php echo base_url('admin/customers') ?>" class="pull-right btn btn-secondary btn-sm"><i class="fa fa-angle-left"></i> Back</a>
                  <?php else: ?>
                    <a href="#" class="text-right btn btn-white text-dark cancel_btn btn-sm"><?php echo trans('customers') ?></a>
                  <?php endif; ?>
                </div>
              </div>
            ...
            <?php if (isset($page_title) && $page_title != "Edit"): ?>
              <div class="card list_area">
                <div class="card-header with-border bg-primary text-white">
                  <?php if (isset($page_title) && $page_title == "Edit"): ?>
                    <span class="card-title pt-2"><?php echo trans('edit') ?> <a href="<?php echo base_url('admin/customers') ?>" class="pull-right btn btn-sm btn-primary btn-sm"><i class="fa fa-angle-left"></i> <?php echo trans('back') ?></a></span>
                  <?php else: ?>
                    <span class="card-title pt-2"><?php echo trans('customers') ?> </span>
                  <?php endif; ?>

                  <div class="card-tools pull-right float-end d-inline">
                   <a href="#" class="pull-right btn btn-sm btn-white text-dark add_btn"><i class="fa fa-plus"></i> <?php echo trans('create-new') ?></a>
                  </div>
                </div>
