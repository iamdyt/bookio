          ...
          <div class="col-md-9 offset-md-1">
            ...
            <?php if (isset($page_title) && $page_title != "Edit"): ?>
              <div class="card list_area">
                <div class="card-header">
                  <?php if (isset($page_title) && $page_title == "Edit"): ?>
                    <span class="card-title pt-2">Edit page <a href="<?php echo base_url('admin/pages') ?>" class="pull-right btn btn-secondary btn-sm"><i class="fa fa-angle-left"></i> <?php echo trans('back') ?></a></span>
                  <?php else: ?>
                    <span class="card-title pt-2"><?php echo trans('pages') ?> </span>
                  <?php endif; ?>
                        ...
                        <tbody>
                          <?php $i=1; foreach ($pages as $row): ?>
                            <tr id="row_<?php echo ($row->id); ?>">
                                ...
                                <td class="actions">
                                  <div class="btn-group">
                                    <button type="button" style="background: none; outline:none; border:none;" class="mt-3 " data-toggle="dropdown" aria-expanded="false">
