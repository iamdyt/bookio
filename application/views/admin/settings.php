                ...
                <div class="row">
                  ...
                  <div class="col-md-9">
                    <form method="post" enctype="multipart/form-data" action="<?php echo base_url('admin/settings/update') ?>" role="form" class="form-horizontal pl-20">
                      <div class="tab-content custom card card-body" id="myTabContent">
                        ...
                        <div class="tab-pane fade" id="prefrences" role="tabpanel" aria-labelledby="prefrences-tab">
                            <div class="form-group">
                                <div class="col-sm-12 mt-15">
                                  ...
                                  <div class="custom-control custom-switch alert alert-secondary border-start border-secondary prefrence-item ml-10">
                                  ...
                                  <div class="custom-control custom-switch alert alert-secondary border-start border-secondary prefrence-item ml-10 mt-25">
                        ...
                        <div class="tab-pane fade" id="mail" role="tabpanel" aria-labelledby="mail-tab">
                          ...
                          <div class="col-sm-12 mt-15">
                              ...
                              <div class="callout callout-default card card-body border-top border-primary">
                      ...
                      <button style="width: 100%;" type="submit" class="btn btn-primary  btn-block mt-3"> <?php echo trans('save-changes') ?></button>
